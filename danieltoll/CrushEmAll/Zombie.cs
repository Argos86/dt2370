...
namespace ZombieHoards
{
    ...
    /// </summary>
    public class Zombie : Microsoft.Xna.Framework.Game
    {
        //Model
        ...
        Controllers.Editor m_editorController;
        ...
        public Zombie()
        {
            ...
            m_editorController = new Controllers.Editor(m_coreView);
            m_game = new ZombieHoards.Model.Game(m_playGameController);
