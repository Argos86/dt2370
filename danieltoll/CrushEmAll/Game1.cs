...
namespace ZombieHoards
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public Game1()
        {
            m_game = new ZombieHoards.Model.Game();
        ...
        protected override void Update(GameTime a_gameTime)
        {
            ...
            m_coreView.Update(a_gameTime);

            if (m_playGameController.Update(m_game, a_gameTime) == false)
            {
                this.Exit();
            }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            m_playGameController.Present(m_game, gameTime, GraphicsDevice);
