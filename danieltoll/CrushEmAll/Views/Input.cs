...
{
    /* Denna klassen är tänkt som en förenkling av input
     * På PC styrs spelare 1 av musen
     * 
     * På XBOX styrs spelare 1 av gamepad
     * 
     * Utåt exponeras ett enklare interface med en update (måste nog ta time)
     * 
     */
    class Input
    {
