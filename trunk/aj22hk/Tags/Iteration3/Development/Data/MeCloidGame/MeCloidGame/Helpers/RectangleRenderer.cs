...
namespace MeCloidGame.Helpers
{
    class RectangleRenderer
    {
        ...
        public RectangleRenderer(GraphicsDevice a_graphicsDevice, float a_alpha)
        {
        ...
        public void Batch(Vector2 a_upperLeft, Vector2 a_upperRight, Vector2 a_lowerRight, Vector2 a_lowerLeft, Color a_color, float a_layerDepth)
        {
            Batch(a_upperLeft, a_color, a_layerDepth);
            Batch(a_upperRight, a_color, a_layerDepth);
            Batch(a_upperRight, a_color, a_layerDepth);
            Batch(a_lowerRight, a_color, a_layerDepth);
            Batch(a_lowerRight, a_color, a_layerDepth);
            Batch(a_lowerLeft, a_color, a_layerDepth);
            Batch(a_lowerLeft, a_color, a_layerDepth);
            Batch(a_upperLeft, a_color, a_layerDepth);
        }
